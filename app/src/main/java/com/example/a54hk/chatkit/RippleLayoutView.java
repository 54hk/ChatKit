 ...
 * @author mrsimple
 */
public class RippleLayoutView extends RelativeLayout {
     ...
     * @param context
     */
    public RippleLayoutView(Context context) {
        super(context);
        init(context, null);
    }

    public RippleLayoutView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public RippleLayoutView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initTypedArray(Context context, AttributeSet attrs) {
        ...
        mRippleColor = typedArray.getColor(R.styleable.RippleLayout_color_s,
                DEFAULT_RIPPLE_COLOR);
        mStrokeWidth =0.0f;
//        mStrokeWidth =
//                typedArray.getDimension(R.styleable.RippleLayout_strokeWidth_s, DEFAULT_STROKE_WIDTH);
        mRippleRadius = 60;
//        mRippleRadius = typedArray.getDimension(R.styleable.RippleLayout_radius_s,
//                DEFAULT_RADIUS);
        mAnimDuration =3000;
//        mAnimDuration = typedArray.getInt(R.styleable.RippleLayout_duration_s,
//                DEFAULT_DURATION_TIME);
        mRippleViewNums =6;
//        mRippleViewNums = typedArray.getInt(R.styleable.RippleLayout_rippleNums_s,
//                DEFAULT_RIPPLE_COUNT);
        mRippleScale = 4.0f;
//        mRippleScale = typedArray.getFloat(R.styleable.RippleLayout_scale_s,
//                DEFAULT_SCALE);
    ...
    private void initPaint() {
      ...
      //  mPaint.setColor(Color.rgb(184, 235,234));
        mPaint.setColor(Color.parseColor("#FEC640"));
    }

    private void initRippleViewLayoutParams() {
        // ripple view的大小为 半径 + 笔宽的两倍
        int rippleSide = (int) (3 * (mRippleRadius + mStrokeWidth));
